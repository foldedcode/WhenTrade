...
class ConfigManager:
    ...
    def _init_mongodb_storage(self):
        ...
        try:
            ...
            database_name = os.getenv("MONGODB_DATABASE_NAME", "core")
    ...
    def _init_default_configs(self):
        ...
        if not self.settings_file.exists():
            # 导入默认数据目录配置
            import os
            default_data_dir = os.path.join(os.path.expanduser("~"), "Documents", "WhenTrade", "data")
            ...
            default_settings = {
                ...
                "results_dir": os.path.join(os.path.expanduser("~"), "Documents", "WhenTrade", "results"),  # 结果目录
    ...
    def load_settings(self) -> Dict[str, Any]:
        ...
        env_settings = {
            ...
            "results_dir": os.getenv("WHENTRADE_RESULTS_DIR", ""),
            "log_level": os.getenv("WHENTRADE_LOG_LEVEL", "INFO"),
            "data_dir": os.getenv("WHENTRADE_DATA_DIR", ""),  # 数据目录环境变量
            "cache_dir": os.getenv("WHENTRADE_CACHE_DIR", ""),  # 缓存目录环境变量
        }
    ...
    def get_env_config_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "other_configs": {
                ...
                "results_dir": os.getenv("WHENTRADE_RESULTS_DIR", "./results"),
                "log_level": os.getenv("WHENTRADE_LOG_LEVEL", "INFO"),
            }
        }
    ...
    def get_data_dir(self) -> str:
        ...
        if not data_dir:
            # 如果没有配置，使用默认路径
            data_dir = os.path.join(os.path.expanduser("~"), "Documents", "WhenTrade", "data")
        return data_dir
...
def _get_project_config_dir():
    """获取项目根目录的配置目录"""
    # 从当前文件位置推断项目根目录
    current_file = Path(__file__)  # core/config/config_manager.py
