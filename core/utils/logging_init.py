...
from core.utils.logging_manager import setup_logging, get_logger
...
def init_logging(config_override: Optional[dict] = None) -> None:
    ...
    # 记录初始化信息
    logger.info("🚀 WhenTrade-CN 日志系统初始化完成")
...
def log_startup_info():
    ...
    env_info = {
        ...
        'WHENTRADE_LOG_LEVEL': os.getenv('WHENTRADE_LOG_LEVEL', 'INFO'),
        'WHENTRADE_LOG_DIR': os.getenv('WHENTRADE_LOG_DIR', './logs'),
    }
